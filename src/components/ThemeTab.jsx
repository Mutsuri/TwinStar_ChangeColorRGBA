...
import ColorSilderKey from './ColorSilderKey';
...
export default function ThemeTab(){
    ...
    const handleAddTab = () => {
        ...
        const existingIndexes = tabs.map(tab => parseInt(tab.label.match(/\d+/), 10));
    ...
    <>
        ...
        <div>
            {tabs.map((tab, index) => (
                ...
                {/* <ColorSlider onDeleteTab={() => handleDeleteTab(index)}/> */}
                <ColorSilderKey onDeleteTab={() => handleDeleteTab(index)}/>
                </div>
            ))}        
        </div>   
